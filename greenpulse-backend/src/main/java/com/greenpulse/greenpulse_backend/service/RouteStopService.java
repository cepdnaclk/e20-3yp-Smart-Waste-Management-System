...
private RouteRepository routeRespository;
private BinStatusRepository binStatusRepository;
    ...
    public RouteStopService(RouteStopRepository routeStopRepository,
                            ...
                            RouteRepository routeRespository,
...
public ApiResponse<RouteStop> assignRouteToStops(List<Long> stopIds) {
        // Create and save new route (with autogenerated ID)
        Route route1 = new Route();
        route1.setStatus(RouteStatusEnum.CREATED);
        route1.setDateCreated(LocalDateTime.now());
        routeRespository.save(route1); // Now route1.routeId is generated
        ...
        return ApiResponse.<RouteStop>builder()
                .success(true)
                .message("Route assigned to stops successfully")
                .data(null) // optionally return route1 or a list of updated RouteStops
                .timestamp(LocalDateTime.now().toString())
                .build();
    }

    @Scheduled(fixedRate = 600000000) // every 10 seconds for testing
